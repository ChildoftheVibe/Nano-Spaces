...
export default function ActivityLogPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-8">
      ...
      <div className="mb-4 flex flex-wrap gap-3 rounded-xl border border-gray-100 bg-gray-50 p-4">
        <div className="min-w-[160px] flex-1">
          <Label className="text-xs text-gray-600">Action contains</Label>
          <Input
              ...
              <tbody className="divide-y divide-gray-50">
                {entries.map((e) => (
                  <tr key={e.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 text-xs font-medium text-gray-700">{e.actor_name}</td>
                    <td className="px-4 py-3">
                      <code className="rounded bg-gray-100 px-1.5 py-0.5 text-xs text-gray-700">
                        {e.action}
                      </code>
                    </td>
                    <td className="px-4 py-3 text-xs text-gray-500">{e.target_type ?? '—'}</td>

  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center gap-6 p-8 text-center">
      <div className="space-y-2">
        <h2 className="text-xl font-bold text-gray-900">This page encountered an error</h2>
        <p className="max-w-sm text-gray-500">
          Something went wrong loading this section. Try again or go back to the calendar.
        </p>
        {error.digest && (
